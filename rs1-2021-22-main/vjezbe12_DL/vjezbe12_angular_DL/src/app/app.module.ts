...
import { SingalrChartPrimjerComponent } from './singalr-chart-primjer/singalr-chart-primjer.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path: 'signalr-chart-primjer', component: SingalrChartPrimjerComponent},
